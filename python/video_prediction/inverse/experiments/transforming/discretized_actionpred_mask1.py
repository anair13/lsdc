...
def get_load_conf():
    ...
    conf['model'] = 't'            #'model architecture to use - CDNA DNA or STP'
    ...
    conf['learning_rate'] = 0.0001      #'the base learning rate of the generator'
...
if __name__ == "__main__":
    model = transforming_dynamics_model.DynamicsModel(get_train_conf())
    model.train(100000, True, init_conf=(100000, get_load_conf()))
