...
def get_conf():
    DATA_DIR = '/home/ashvin/lsdc/pushing_data/finer_temporal_resolution_substep10_small/train'
    conf = collections.OrderedDict()
    conf['experiment_name'] = 'discretized_actionpred'
    conf['data'] = 'ftrs_small'
    ...
    conf['learning_rate'] = 0.1      #'the base learning rate of the generator' 
