...
from video_prediction.inverse.transforming_dynamics_model import DynamicsModel
...
def setup_predictor(conf, gpu_id = 0):
    ...
    def predictor_func(input_images=None, one_hot_images=None, input_state=None, input_actions=None):
        ...
        gen_images = None
        gen_states = out
        return gen_distrib, gen_images, gen_states
